...
| `AGENTS.md` (this file) | Contributors and maintainers | Maintainer conventions, source-of-truth rules, design rationale |
...
| Maintainer convention or durable repo rule | `AGENTS.md` |
